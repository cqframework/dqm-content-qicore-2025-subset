# dqm-content-qicore-2025-subset
dQM Measure Content Testing Subset (Using QICore 6.0.0, based on FHIR R4 v4.0.1)

This repository is a focused testing subset of the measures in the [dqm-content-qicore-2025](http://github.com/cqframework/dqm-content-qicore-2025) repository, which are FHIR-based measures and shared libraries translated from the QDM-based versions of eCQMs that were published in May 2025 for the 2026 reporting year, exported from MADiE after final review and updates, in preparation for public comment review.

This repository focuses on:

**Eligible Clinician Measures**
...
https://build.fhir.org/ig/cqframework/dqm-content-qicore-2025-subset
...
```
   ...
   |-- bundles
       ...
       |-- measure
           |-- <bundles>
   |-- input
       |-- dqm-content-qicore-2025-subset.xml
       |-- cql
           |-- <library name>.cql
       |-- pagecontent
       |-- resources
